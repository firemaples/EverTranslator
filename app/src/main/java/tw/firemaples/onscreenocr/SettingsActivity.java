...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || TextRecNTransPreferenceFragment.class.getName().equals(fragmentName);
    }
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class TextRecNTransPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_text_recognition_translation);
            setHasOptionsMenu(true);
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            bindPreferenceSummaryToValue(findPreference(KEY_RECOGNITION_LANGUAGE));
            bindPreferenceSummaryToValue(findPreference(KEY_TRANSLATION_TO));
        }
