...
object OCRLangUtil : BaseSettingUtil() {
    ...
    val ocrLangCodeList: Array<String>
        get() = context.resources.getStringArray(R.array.ocr_langCode_iso6393)

    val ocrLangNameList: Array<String>
        get() = context.resources.getStringArray(R.array.ocr_langName)

    val ocrLangDisplayCodeList: Array<String>
        get() = context.resources.getStringArray(R.array.ocr_langDisplayCode)
