...
public class OrcInitAsyncTask extends AsyncTask<Void, String, Boolean> {
    ...
    public OrcInitAsyncTask(Context context, TessBaseAPI baseAPI, String recognitionLang, String recognitionLangName, CaptureViewHandler captureViewHandler) {
        ...
        this.tessRootDir = new File(context.getCacheDir() + File.separator + "tesseract");
